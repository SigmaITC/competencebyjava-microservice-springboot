package se.chriskevin.microservice.springboot.services;
...
class UserServiceTest {
  ...
  void verifyGetUser() {
    ...
    assertThat(userService.getUser(TEST_UUID)).isEqualTo(expected);
  }
  ...
  void verifyRemoveUser() {
    ...
    assertThat(userService.deleteUser(TEST_UUID)).isEqualTo(expected);
  }
  ...
  void verifyAddUser() {
    ...
    assertThat(userService.addUser(new WritableUserDetails(TEST_FIRST_NAME_STRING)))
        .isEqualTo(expected);
  }
  ...
  void verifyUpdateUser() {
    ...
    assertThat(userService.updateUser(TEST_UUID, new WritableUserDetails(TEST_FIRST_NAME_STRING)))
        .isEqualTo(expected);
  }
}
